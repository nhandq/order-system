                                ...
                                <li>
                                    <div class="dw-user-box">
                                        ...
                                        <div class="u-text">
                                            ...
                                            <p class="text-muted">{{getAuthUser('email')}}</p><router-link to="/profile" class="btn btn-rounded btn-danger btn-sm">Tài khoản</router-link></div>
                                    </div>
                                </li>
                                <li role="separator" class="divider"></li>
                                <li><router-link to="/profile"><i class="fa fa-user"></i> Thông tin tài khoản</router-link></li>
                                <li role="separator" class="divider"></li>
                                <li><router-link to="/configuration"><i class="fa fa-cogs"></i> Thiết lập</router-link></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="#" @click.prevent="logout"><i class="fa fa-power-off"></i> Đăng xuất</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
