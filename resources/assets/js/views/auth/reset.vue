<template>
    <section id="wrapper">
        <div class="login-register" style="background-image:url(/images/background/background.jpg);">
            ...
            <div class="card-body">
                <h3 class="box-title m-b-20 text-center">Tạo mật khẩu</h3>
                <div v-if="!showMessage">
                    <form class="form-horizontal form-material" id="resetform" @submit.prevent="submit">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input type="password" name="password" class="form-control" placeholder="Mật khẩu" v-model="resetForm.password"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input type="password" name="password" class="form-control" placeholder="Nhập lại mật khẩu" v-model="resetForm.password_confirmation"> </div>
                        </div>
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Gửi yêu cầu</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="form-group m-b-0">
                    ...
                    <p><router-link to="/login" class="text-info m-l-5"><b>Đăng nhập</b></router-link></p>
                    </div>
                </div>
            </div>
